export default new class ComplementaryColor {
  ...
  random():[number,number,number] {return [this.randomChannel(), this.randomChannel(), this.randomChannel()]}

  private randomChannel():number { return Math.floor(Math.random() * 256)};
